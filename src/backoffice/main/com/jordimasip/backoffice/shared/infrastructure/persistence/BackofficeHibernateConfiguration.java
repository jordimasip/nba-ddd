package com.jordimasip.backoffice.shared.infrastructure.persistence;
...
public class BackofficeHibernateConfiguration {
    ...
    private List<Resource> searchMappingFiles() {
        String path = "./src/backoffice/main/com/jordimasip/backoffice/";
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl(
            "jdbc:mysql://localhost:3306/nba_ddd_backoffice?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
